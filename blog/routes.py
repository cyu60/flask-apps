...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('home'))
    return render_template('create_post.html', title="New Post", form=form, legend='Create Post', button_label="Post")
...
def update_post(post_id):
    ...
    return render_template('create_post.html', title="Update Post", form=form, legend='Update Post', button_label="Update")
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash("If this email is linked to an account, an email has been sent with instructions to reset your password", "info")
...
def reset_token(token):
    if current_user.is_authenticated:
        return redirect(url_for('home')) # take a look at this eventually
